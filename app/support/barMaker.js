    ...
    applyRenderer, queryTools
        ...
        return {
            ...
            createChartData: function (selection, settings, bins) {
                ...
                if (bins_new = 7) {
                    color = ["#FBE789", "#E2DD8C", "#C9D38F", "#B0CA93", "#97C096", "#7EB699", "#65AD9D"];
                }
                else if (bins_new = 8) {
                    color = ["#FBE789", "#E2DD8C", "#C9D38F", "#B0CA93", "#97C096", "#7EB699", "#65AD9D", "#4CA3A0"];
                }
                else if (bins_new = 9) {
                    color = ["#FBE789", "#E2DD8C", "#C9D38F", "#B0CA93", "#97C096", "#7EB699", "#65AD9D", "#4CA3A0", "#3399A3"];
                }
                else if (bins_new = 10) {
